    ...
    <div className="topborder ">
      <div className="container" id="youtube">
        ...
        <div className="text mb-20 text-center">
          ...
          traded manually. Feel free to watch and enjoy. No shame in making fun
          of my Yolo'ing in front of a camera!
        </div>
          ...
          <div className="rounded border-2 bg-white p-4">
            <div className="pb-4">
              ...
              <div className="mb-4 text-center text-sm">
                ...
                trades. This helps working on one's technical analysis skills,
                as well as practicing reading the markets.
              </div>
            </div>
            <iframe
              width="100%"
